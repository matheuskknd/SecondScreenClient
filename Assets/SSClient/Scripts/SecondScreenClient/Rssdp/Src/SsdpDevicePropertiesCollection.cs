...
namespace Rssdp {
	...
	public class SsdpDevicePropertiesCollection : IEnumerable<SsdpDeviceProperty> {
		...
		private readonly IDictionary<string,SsdpDeviceProperty> _Properties;
		...
		public void Add( SsdpDeviceProperty customDeviceProperty ) {
			...
			if( customDeviceProperty == null ) {
				throw new ArgumentNullException("customDeviceProperty");
			}

			if( string.IsNullOrEmpty(customDeviceProperty.FullName) ) {
				throw new ArgumentException("customDeviceProperty.FullName cannot be null or empty.");
			}
		...
		public bool Remove( string customDevicePropertyFullName ) {
			...
			if( string.IsNullOrEmpty(customDevicePropertyFullName) ) {
		...
		public SsdpDeviceProperty this[string fullName] => _Properties[fullName];
